...
![](screenshots/06-describe-instances-ip-output.png)
![](screenshots/06-describe-instances-DNS-output.png)
![](screenshots/06-describe-instances-ami-output.png)
I nmaped the public ip address and found 2 open services ssh and http
![](screenshots/07-nmap-scan-results.png)
Checking the http service i found this web site 
![](screenshots/08-ssrf-demo-webapp.png)
...
![](screenshots/09-ssrf-request-to-imds-root.png)
The vulnerability worked it displayed the instance's updates one of them is latest.
![](screenshots/10-imds-latest-folder.png)
Accessing latest I found the meta-data folder
![](screenshots/10-imds-latest-metadata-folder.png)
In this folder I found the iam folder that has temporary ec2 creds
![](screenshots/11-imds-iam-security-credentials.png)
I used these creds to access the new account 
![](screenshots/12-role-creds-identity-confirmed.png)
This account has some control over the S3 service
![](screenshots/13-s3-bucket-discovery.png)
![](screenshots/13-s3-bucket-discovery.png)
I found a secret s3 bucket. In this bucket there another file that has credentials
![](screenshots/14-s3-credentials-file-extracted.png)
I accessed this account but before that i must delete the temporary token
![](screenshots/15-shepard-identity-confirmed.png)
...
![](screenshots/16-scenario-complete-output.png)
